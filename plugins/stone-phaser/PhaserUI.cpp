...
PhaserUI::PhaserUI()
    : UI(cairo_image_surface_get_width(sImgBackground.get()),
      ...
      fParameters(new DISTRHO::Parameter[StonePhaserDsp::NumActives]),
      fSliderForParameter(new SkinSlider *[StonePhaserDsp::NumActives]()),
      fToggleButtonForParameter(new SkinToggleButton *[StonePhaserDsp::NumActives]()),
      fIndicatorForParameter(new SkinIndicator *[StonePhaserDsp::NumActives]()),
      fFontEngine(new FontEngine)
{
    ...
    for (uint32_t index = 0; index < StonePhaserDsp::NumActives; ++index)
...
{
    DISTRHO_SAFE_ASSERT_RETURN(index < StonePhaserDsp::NumActives, nullptr);
...
{
    DISTRHO_SAFE_ASSERT_RETURN(index < StonePhaserDsp::NumActives, 0.0)
